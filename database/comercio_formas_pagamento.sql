...
CREATE TABLE `formas_pagamento` (
  ...
  KEY `fk_formas_pagamento_bancos` (`id_banco`),
  CONSTRAINT `fk_formas_pagamento_bancos` FOREIGN KEY (`id_banco`) REFERENCES `bancos_financeiras` (`id_banco`)
...
INSERT INTO `formas_pagamento` VALUES (1,'pix',1),(2,'boleto',2),(3,'cartão',3),(4,'deposito',4),(5,'transferencia',5),(6,'doc',6),(7,'pix',7),(8,'boleto',8);
